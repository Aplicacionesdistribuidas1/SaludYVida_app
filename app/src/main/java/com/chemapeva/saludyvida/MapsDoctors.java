...
public class MapsDoctors extends FragmentActivity implements OnMapReadyCallback {
    private Marker mar;
    GoogleMap mMap;
    private double lat;
    private double lon;
...
//        l2.setLatitude(lat);
    ...
    private void addMarker(LatLng latlng, String Nombre, String Direccion) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.w));
    ...
    private class RetrieveTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            String strUrl = "https://bware.000webhostapp.com/ListarNutricionistas.php";
            URL url = null;
            StringBuffer sb = new StringBuffer();
            try {
                url = new URL(strUrl);
    ...
    private class ParserTask extends AsyncTask<String, Void, List<HashMap<String, String>>> {
        ...
        protected List<HashMap<String, String>> doInBackground(String... params) {
            MarkerNutricionistaJSONParser markerParser = new MarkerNutricionistaJSONParser();
